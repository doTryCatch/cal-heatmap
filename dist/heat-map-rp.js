...
// src/heat-map-rp.tsx
var heat_map_rp_exports = {};
__export(heat_map_rp_exports, {
  default: () => heat_map_rp_default
});
module.exports = __toCommonJS(heat_map_rp_exports);
...
var HeatMap = ({
  ...
  (0, import_react.useEffect)(() => {
    ...
    allBoxElems.forEach((elem) => {
      elem.addEventListener("mouseenter", () => showMsg(elem));
      elem.addEventListener("mouseleave", () => dropMsg(elem));
    });
    return () => {
      allBoxElems.forEach((elem) => {
        elem.removeEventListener("mouseenter", () => showMsg(elem));
        elem.removeEventListener("mouseleave", () => dropMsg(elem));
      });
    };
  }, [dates, backgroundColor, padding, borderRadius, boxShadow, textColor]);
  return /* @__PURE__ */ import_react.default.createElement("section", { className: "heatmap w-full flex space-x-4" }, /* @__PURE__ */ import_react.default.createElement("div", { className: "map-area", style: { backgroundColor: gridBgColor } }, monthLabels && /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
    ...
    months.map((month, index) => /* @__PURE__ */ import_react.default.createElement(
      "span",
      {
        key: index,
        style: {
  ...
  ), /* @__PURE__ */ import_react.default.createElement("div", { className: "flex space-x-4" }, dayLabelsVisible && /* @__PURE__ */ import_react.default.createElement(
    "div",
    {
      className: "days",
      style: {
    ...
    dayLabels.map((day, index) => /* @__PURE__ */ import_react.default.createElement(
      "span",
      {
...
var heat_map_rp_default = HeatMap;
...
react/cjs/react.development.js:
   ...
   *)
*/
//# sourceMappingURL=heat-map-rp.js.map